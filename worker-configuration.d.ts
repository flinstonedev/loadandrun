/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: c24f540490d2f1c92eddca0c2bf66b6d)
// Runtime types generated with workerd@1.20260918.1 2026-09-04 nodejs_compat
interface __BaseEnv_Env {
	...
	WORKOS_ALLOWED_ORIGINS: string;
	WORKOS_ISSUER: string;
	SPACES_AI_ENABLED: string;
	AI_MODEL: string;
	WORKOS_ENVIRONMENT: string;
	WORKSPACES: DurableObjectNamespace<import("./worker/index").Workspace>;
	SPACES: DurableObjectNamespace<import("./worker/index").Space>;
	WIDGETS: DurableObjectNamespace<import("./worker/index").Widget>;
	SPACE_DIRECTORIES: DurableObjectNamespace<import("./worker/index").SpaceDirectory>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Workspace" | "Space" | "Widget" | "SpaceDirectory";
	}
	interface LocalEnv {
		ASSETS: Fetcher;
		ENVIRONMENT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "WORKSPACE_ID" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "SPACES_ENABLED" | "AUTH_PROVIDER" | "WORKOS_CLIENT_ID" | "WORKOS_ALLOWED_ORIGINS" | "WORKOS_ISSUER" | "SPACES_AI_ENABLED" | "AI_MODEL" | "WORKOS_ENVIRONMENT">> {}
}
